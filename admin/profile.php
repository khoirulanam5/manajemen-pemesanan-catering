...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name="level" class="form-control">
            ...
            <option value="Pemilik" <?= ($pecah['level'] == "Pemilik") ? "selected" : ""; ?>>Pemilik</option>
            <option value="Kasir" <?= ($pecah['level'] == "Kasir") ? "selected" : ""; ?>>Kasir</option>
            <option value="Dapur" <?= ($pecah['level'] == "Dapur") ? "selected" : ""; ?>>Dapur</option>
        </select>
    </div>
